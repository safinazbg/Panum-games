<template>
  <div
      ...
      class="title flex flex-col justify-evenly items-center h-full gamifiedp ">
    <h1 class=" gamifiedh1 text-center py-12">
      Comparison task trial
    </h1>
    <p class="text-center w-1/2 text-md">
    ...
    <p class="text-md">The first 2 rounds are trials again.</p>
    <p class="text-md">Good luck and have fun!</p>
