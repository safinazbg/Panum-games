<template>
  <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24" id="quiz"><g><path fill="#d0ccff" d="M21.1,14.2l-0.2,0.2C20.3,15,20,15.8,20,16.6v0.3c0,1.7-1.4,3.1-3.1,3.1h-0.3c-0.8,0-1.6,0.3-2.2,0.9l-0.2,0.2
		...
		c-0.5,0.3-0.9,0.9-0.9,1.6V14"></path><path fill="#6f51f8" d="M12,18L12,18c-0.6,0-1-0.4-1-1v0c0-0.6,0.4-1,1-1h0c0.6,0,1,0.4,1,1v0C13,17.6,12.6,18,12,18z"></path></g></svg>
</template>
